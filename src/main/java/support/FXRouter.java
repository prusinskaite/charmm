...
public final class FXRouter {
    ...
    public static ResourceBundle getBundle(String language) {
        if (language.equalsIgnoreCase("base") || language.equalsIgnoreCase("en")) {
            return ResourceBundle.getBundle("locales.messages");
        } else {
            return ResourceBundle.getBundle(String.format("locales.messages_%s", language));
        }
    }
